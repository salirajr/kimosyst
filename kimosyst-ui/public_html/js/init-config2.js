...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
            ...
            .state('xinput.crosspemasukan', {
                url: "/crosspemasukan",
                templateUrl: "sviews/input-pemasukan.html",
            ...
            .state('xcross.inputmutasi', {
                url: "/inputmutasi",
                templateUrl: "sviews/mutasi-inputcsv.html",
                controller: mutasiXCrossCtrl,
                resolve: {
                    loadPlugin: function ($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            {
            ...
            .state('xcross.inputpemasukan', {
                url: "/inputpemasukan",
                templateUrl: "sviews/mutasi.html",
                controller: mutasiXCrossCtrl,
                resolve: {
                    loadPlugin: function ($ocLazyLoad) {
                        return $ocLazyLoad.load([
            ...
            .state('income.findall', {
                url: "/findall",
                templateUrl: "sviews/income-findall.html",
                controller: vWMutasiXIncomePrintCtrl,
            ...
            .state('vw.mutasixincome', {
                url: "/mutasixincome",
                templateUrl: "sviews/vw-mutasixincome.html",
                controller: vWMutasiXIncomeCtrl,
                resolve: {
                    loadPlugin: function ($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            {
            ...
            .state('rfrc.xcross', {
                url: "/xcross",
                templateUrl: "sviews/rfrc-xcross.html",
                controller: rfrcXCrossCtrl,
                resolve: {
                    loadPlugin: function ($ocLazyLoad) {
                        return $ocLazyLoad.load([
                            {
