...
public class CrapBW {
    ...
    protected String command_uri = "";
    protected String method = "";
    protected String query_string = "";
    protected String post_data = "";
    protected int timeout_millisec = 1000;
...
* Available Variables: DO NOT MODIFY *****/
        ...
        port = "37001";
        method = "POST";
        command_uri = "/rp-server/authentication/login";
        ...
        try {
            ...
            if (use_ssl_cert) {
                ...
                TrustManager[] trust_mgr = getTrustManagerWithoutTrustedFlag();
 ...
 post_data = "{\"LoginRequest\":{\"user\":\"crmadmin\",\"password\":\"Crmadmin11\"}}";
            if (use_post_data) {
                con.setDoOutput(true);
                con.setRequestMethod(method);
                if (post_data != null && post_data.length() > 0) {
                    System.out.println("crap.util.https.CrapBW.invoke() : " + post_data);
            ...
            int stsCode = con.getResponseCode();
            status_code = stsCode + "";
    ...
    private TrustManager[] getTrustManagerWithoutTrustedFlag() {
        TrustManager[] certs = new TrustManager[]{
            new X509TrustManager() {
                public X509Certificate[] getAcceptedIssuers() {
                    return null;
