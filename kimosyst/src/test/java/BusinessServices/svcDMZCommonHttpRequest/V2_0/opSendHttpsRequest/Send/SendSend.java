package BusinessServices.svcDMZCommonHttpRequest.V2_0.opSendHttpsRequest.Send;
...
public class SendSend {
    ...
    protected int timeout_millisec = 0;
...
* Available Variables: DO NOT MODIFY *****/
        ...
        boolean use_post_data = !("GET".equals(method)) || !("DELETE".equals(method));
